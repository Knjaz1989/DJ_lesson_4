...
class Scope(models.Model):
    ...
    articles = models.ManyToManyField(Article,verbose_name='Статьи', through='ArticleScope')
...
class ArticleScope(models.Model):
    ...
    tag = models.ForeignKey(Scope, on_delete=models.CASCADE, related_name='scopes')
